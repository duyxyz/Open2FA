...
window.openModal = function (modalId) {
  ...
  // Always show authModal, addTokenModal, exportModal, and importModal as dropdowns on PC
  if (modalId === 'authModal' || modalId === 'addTokenModal' || modalId === 'exportModal' || modalId === 'importModal') {
